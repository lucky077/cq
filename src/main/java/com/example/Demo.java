...
public class Demo extends JcqAppAbstract implements ICQVer, IMsg, IRequest {
    ...
    public static void setCoreService(CoreService coreService) {
        Demo.coreService = coreService;
    }
    ...
    private static void debug(){
        ...
        demo.groupMsg(0, 10008, 492155062l, 0L, "", "赌博 1000", 0);
    ...
    public int startup() {
        ...
        File parentFile = new File(appDirectory).getParentFile().getParentFile().getParentFile().getParentFile();
        Variable.rootPath = parentFile.getPath();
        Variable.imageCachePath = Variable.rootPath + "/data/image/cache";
        // 返回如：D:\CoolQ\app\com.sobte.cqp.com.sobte.cqp.com.sobte.cqp.jcq\app\com.example.demo\
    ...
    public int groupMsg(int subType, int msgId, long fromGroup, long fromQQ, String fromAnonymous, String msg,
        ...
        Message message = new Message(subType,msgId,fromGroup,fromQQ,fromAnonymous,msg,font,null);
